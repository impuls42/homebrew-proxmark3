class Proxmark3 < Formula
  ...
  def install
    ...
    args << "SKIPQT=1" if build.without? "qt@5"
    ...
    ohai "The latest bootloader and firmware binaries are ready and waiting " \
         "in the current homebrew Cellar within share/firmware."
  end
